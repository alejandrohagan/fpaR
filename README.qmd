...
2024-03-01
- need printing method for ti object
- define unit testing plan
  - how are period to period imbalances handled
  - pick a month
    - do ytd for both periods
    - then do a join
    - then control for the behavior
- finalize ti documentation
- harmonize apparoch to
  - abc
  - chort_date
  - count_plus 
    -  adjust for when a grouped object is passed
  - make segmentation
- clean up publication 
- use github actions to automatme some bill
- clean up readme
- factor analysis will come in second package release
- lets get ti going and instractucture devleoped
