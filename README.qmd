...
-  Period imbalances between periods (Eg. the different number of days between February vs. January) can create misleading

-  Your organization many use a non-standard calendar such as a 5-5-4, 4-4-5, or 13 month calendar and you need the ability to do time intelligence functions
