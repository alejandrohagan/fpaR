...
tibble::tribble(
   ~"Short Name",~"Description",
    ...
    "MTD",  "Month-to-date",
    "WTD",  "Week-to-date",
    "MoM",  "full Month over full Month",
    "MoMTD", "month to date over this time last month to date"
    "WoW",  "Week over Week",
    "YoY",  "Year over Year",
    "PMTD", "Prior month's MTD amount",
    "PYTD", "Prior year MTD amount",
    "PWTD", "Prior month's MTD amount",
    ...
    "MAT", 	"Moving annual total of previous 342 days", 	  		 
